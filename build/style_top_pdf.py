...
HOME_HIDE = {
    ...
    # ── 2026-09-21 표준 8종 교체로 **새로 빠진 셋** ──────────────────────────
    "grow": "사용자 결정(2026-09-21) — 성장은 가치(HML)의 **공매도 다리**지 독립 표준 축이 아니다. "
            "표준 8종에 자리가 없어 뺀다(성적 때문이 아니다)",
    "hbeta": "사용자 결정(2026-09-21) — 저변동(BAB)의 **반대 방향**이라 같은 축이다. "
             "표준 쪽(lowvol)을 남기고 이쪽을 뺀다",
