...
ETF_SHARPE_TK = ("SPY", "QQQ", "DIA", "IWM", "MTUM", "QUAL", "IVE", "USMV", "RPG", "SPHB",
                 "RSP", "SDY", "SIZE",
                 # 2026-08-13 홈 표에 더한 7종. 여기 안 넣으면 그 일곱 줄의 샤프가 '—' 로
                 #   남는데, 그 열이 이 묶음의 **정렬 기준**이라 새 줄이 통째로 맨 밑에 깔린다.
                 #   ⚠ 5년 창을 못 채우는 것은 그대로 None 이다(SPMO 는 2015-11 상장이라
                 #     5년 창은 되고, 1년 창은 전부 된다). 지어내지 않는다.
                 "SPMO", "IVW", "RPV", "SPLV", "SCHD", "VYM", "PKW")
