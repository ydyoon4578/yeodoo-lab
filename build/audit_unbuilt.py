...
KNOWN = {
    ...
    "_idxeg.json":
        ...
        "PIT 패널 · TE 2%% · 비중비례 칸 IR S&P +0.461(t 1.32) · NDX +0.499(t 1.43). **자동 재굽기 금지 — 기록이다.** "
    ...
    "_rally.json":
        ...
        "직전 특징 여섯 × 두 지수 사건 연구 — F1 통과 0칸. 거래량 증가는 큰 상승·큰 하락을 같이 늘리고(1.13·1.12), 거래량 동반 신고가는 "
        "오늘 명단에서만 1.46배. **자동 재굽기 금지 — 기록이다.**",
    "_guru_cmp.json":
        "얼린 사전등록 측정(PREREG-2026-09-23-GURUCMP · **기각** · F1 두 지수). 거장 합의 점수 틸트 — PIT 패널 · TE 2%% · "
        "비중비례 IR S&P +0.395(t 1.13) · NDX +0.489(t 1.40) · 생존 편향 동일가중 연 1.6~2.7%%p. strategy_index.py 가 "
