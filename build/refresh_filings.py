...
# 전신 CIK 정본은 build/edgar.py의 PREDECESSOR다 — 공시와 재무 두 파이프라인이 같은 표를 봐야 한다.
# 빠뜨림은 아래 MIN_IR_FORMS 검사가 이력이 빈약한 종목을 잡아 잡 로그에 경고로 띄운다.
PREDECESSOR = edgar.PREDECESSOR
