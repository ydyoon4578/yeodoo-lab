...
GURUS = {
    1067983: "버크셔 해서웨이 (버핏)",
    1061768: "바우포스트 (클라만)",
    # 🚨 2026-08-19 — 퍼싱스퀘어가 신고 법인을 바꿨다. 옛 CIK(1336528)는 2026-06-30 에
    #   13F-NT(대신 신고했다는 통지)만 내고, 보유는 새 법인 PERSHING SQUARE INC. 로 간다.
    #   ⚠ 옛 CIK 를 남겨 두면 «앞 분기 보유 + 이번 분기 날짜» 가 된다(위 13F-HR 필터가
    #     그 자체는 막지만, 그러면 이번 분기가 통째로 안 보인다). 그래서 갈아탄다.
    2026053: "퍼싱스퀘어 (애크먼)",
    1656456: "아팔루사 (테퍼)",
