...
def build_strats():
    ...
    xsec("x-custconc", "고객 집중도 상위 10 (단일 고객 매출 비중)",
         ...
         "**뜻이 정반대인 문장**을 드러냈다. 부정 검사를 매치 구간 안에서만 하고 있었는데 "
         ...
         "⚠ data/_custconc_raw.json 은 이름과 달리 **원문이 아니라 재개용 결과 체크포인트**다 — "
         "오프라인 재추출은 여전히 불가능하고 EDGAR 재수집이 필요하다. "
         "재수집·재측정 전까지 이 규칙의 수치(t 4.09 · incr5 2.8)를 근거로 쓰지 말 것.")
