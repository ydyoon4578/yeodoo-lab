...
🚨 등록서에 적은 것만 한다. 결과를 보고 자산 수(8/9)·선택 크기(상위 절반)·
   신호(12-1)·주기(월말)를 바꾸지 않는다. 16종판은 만들지 않는다.
🚨 9번째 축(fcfy)은 **성적을 본 뒤 고른 사용자 결정**이다(등록서 §3-1-a).
   그래서 fmom9 > fmom 은 «스타일을 늘리면 좋아진다» 의 증거가 아니다.
"""
...
NINE = EIGHT + ["fcfy"]     # 🚨 사용자 결정 2026-09-21 (§3-1-a)
